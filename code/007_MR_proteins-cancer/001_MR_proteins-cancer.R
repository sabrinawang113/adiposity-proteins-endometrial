...
write.table(data_exposure, "analysis/007_MR_proteins-cancer/data_exposure.txt",
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")

## outcome ====
data_outcome <- fread("analysis/002_outcomes/cancer/instruments-proteins_outcome-cancer.txt")
write.table(data_outcome, "analysis/007_MR_proteins-cancer/data_outcome.txt",
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")

## harmonise ====
data_harmonise <- harmonise_data(data_exposure, data_outcome, action=2)
write.table(data_harmonise, "analysis/007_MR_proteins-cancer/data_harmonise.txt",
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")

## MR ====
data_mr <- mr(data_harmonise, method_list = methods)
write.table(data_mr, "analysis/007_MR_proteins-cancer/data_mr.txt",
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
