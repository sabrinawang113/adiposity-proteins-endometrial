...
# data ====
data <- fread("analysis/001_instruments/adiposity/instruments_adiposity.txt")
...
# save ====
write.table(data_all, "analysis/002_outcomes/cancer/instruments-adiposity_outcome-cancer.txt",
