...
# data ====
data <- fread("analysis/001_instruments/cancer/instruments_cancer.txt")
...
# extract cancer SNPs from adiposity GWAS
...
# save ====
write.table(data_all, "analysis/002_outcomes/adiposity/instruments-cancer_outcome-adiposity.txt",
