...
# file paths ====
DIRECTORY_OUT <- "/home/wangs/_PROJECTS/adiposity-proteins-endometrial/analysis/009_colocalization/ECAC-nonendometrioid/"
...
list_files_outcome <- list_files_outcome[2]
## label_outcome
