...
# file paths ====
DIRECTORY_OUT <- "/home/wangs/_PROJECTS/adiposity-proteins-endometrial/analysis/009_colocalization/ECAC-endometrioid/"
...
list_files_outcome <- list_files_outcome[1]
## label_outcome
